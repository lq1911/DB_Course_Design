...
<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="flex pt-16">
      <aside class="fixed left-0 top-16 bottom-0 w-52 bg-white shadow-sm overflow-y-auto z-40">
        <nav class="p-4">
          <div class="space-y-2">
            <div
      ...
      <main class="ml-52 flex-1 p-6 relative z-10">
        ...
        <div v-if="errorMessage" class="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
              <button @click="retryLoad" class="btn-outline btn-small text-red-600 border-red-300 hover:border-red-500 hover:text-red-700">重试</button>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
          <div class="flex space-x-4">
            <button
              ...
              :class="{
                'btn-primary btn-medium': activeOrderTab === tab.value,
                'btn-outline btn-medium': activeOrderTab !== tab.value
              }"
        ...
        <div v-if="activeOrderTab === 'orders'">
          <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/30 overflow-hidden relative z-20">
            ...
            >
              ...
              <el-table-column prop="paymentTime" label="支付时间" width="140" />
              <el-table-column prop="customerId" label="客户ID" width="80" align="center" />
              <el-table-column prop="storeId" label="门店ID" width="80" align="center" />
                ...
                <template #default="scope">
                  <div class="flex flex-wrap items-center gap-2">
                    <button
                      ...
                      class="btn-primary btn-small min-w-[100px] shrink-0"
                    >
                    ...
                    <button
                      ...
                      class="btn-success btn-small min-w-[100px] shrink-0"
                    >
                    ...
                    <button
                      ...
                      class="btn-danger btn-small min-w-[100px] shrink-0"
                    >
                    ...
                    <button
                      ...
                      class="btn-info btn-small min-w-[100px] shrink-0"
                    >
                    ...
                    <button
                      ...
                      class="btn-warning btn-small min-w-[100px] shrink-0"
                    >
                    ...
                    <button
                      ...
                      @click="openDeliveryInfo(scope.row)"
                      class="btn-secondary btn-small min-w-[100px] shrink-0"
                    >
              ...
              <el-table-column label="操作" width="280">
                <template #default="scope">
                  <div class="flex space-x-2">
                    <button @click="editDish(scope.row)" class="btn-primary btn-small">
                    ...
                    <button @click="toggleSoldOut(scope.row)" class="btn-small" :class="{ 'btn-danger': scope.row.isSoldOut === 0, 'btn-success': scope.row.isSoldOut === 1 }">
                      <el-icon class="mr-1" v-if="scope.row.isSoldOut === 0"><Remove /></el-icon>
                      <el-icon class="mr-1" v-else><Check /></el-icon>
          ...
          <div v-if="showDishForm" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg p-6 w-[500px]">
              ...
              <div class="flex justify-end space-x-3 mt-6">
                ...
                <button @click="createDishHandler" class="btn-info btn-medium">
          ...
          <div v-if="showEditForm" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg p-6 w-[500px]">
              ...
              <div class="flex justify-end space-x-3 mt-6">
                ...
                <button @click="updateDishHandler" class="btn-info btn-medium">
                  <el-icon class="mr-1"><Check /></el-icon>
                  保存
                </button>
              </div>
    ...
    <div v-if="showPublishDialog" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg w-[520px] p-6">
        ...
        <div class="flex justify-end space-x-2 mt-6">
          ...
          <button @click="submitPublish" class="btn-primary btn-medium">
            <el-icon class="mr-1"><Van /></el-icon>
            发布
          </button>
        </div>
...
import { Bell, House, List, Ticket, Warning, User, Plus, View, Check, Close, Van, InfoFilled, Edit, Remove } from '@element-plus/icons-vue';
